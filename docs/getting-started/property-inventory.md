...
- The inventory remains associated with the active case.
- Property items and notes are saved automatically.
- The Property Inventory displays a **Sent** status in Compliance.
- The sent inventory is available for inclusion in the Case Packet.
- First Call and Witness Signature retain their own independent statuses.

## Correct or recover the workflow

- **An item or note is incorrect:** Reopen **Property Inventory**, correct the
  information, and confirm that the change is saved.
- **Sharing is canceled:** Return to Property Inventory. The inventory changes
  remain saved to the case.
- **Delivery is uncertain:** Check the selected external app. Mortuary T records
  the handoff to the app, not delivery to the recipient.
- **The inventory remains Started:** Return to **View in Compliance** and select
  **Send to Compliance**.
...
- Inventory changes are saved to the active case automatically.
- Sharing the inventory summary and sending the inventory to Compliance are
  separate actions.

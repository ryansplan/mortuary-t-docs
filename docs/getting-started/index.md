...
2. Verify that First Call displays **Needs Review** and that **Review First
   Call** is available.
3. Verify that the matching case appears as **Current** under **Current / Recent
   Cases**.
4. Select **View in Compliance** to confirm that the First Call was saved to the
   compliance case.

## Expected result

- The case has a unique Case Ref and identifies the user as Case Owner.
- The First Call summary is saved to Compliance.
- First Call displays a **Needs Review** status after the save-and-share action.
- The selected external app receives the summary for sending.
- Property Inventory and Witness Signature retain their own independent
  statuses.

## Correct or recover the workflow

- **Information is incorrect before sharing:** Select **Edit First Call**,
  correct the information, and review the summary again.
- **Information needs attention after sharing:** Select **Review First Call**
  from **Active Case Workflow**.
- **Sharing is canceled:** Confirm the First Call remains available through
  **View in Compliance**, then return to the summary when you are ready to share.
- **Delivery is uncertain:** Check the selected messaging app. Mortuary T
  records the handoff to the app, not delivery to the recipient.
...
- **Save & Share First Call Summary** combines two actions: saving the First
